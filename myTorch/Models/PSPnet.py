...
import myTorch.nn.Wrapped
from myTorch.Models import ResNetModel
...
class PSPNet(nn.Module):
    def __init__(self, n_classes=3, sizes=(1, 2, 3, 6), psp_size=2048, deep_features_size=1024, backend='resnet34',
                 pretrained=True):
        super().__init__()
        self.feats = getattr(ResNetModel, backend)(pretrained)
...
if __name__ == "__main__":
    ...
    writer.add_image('input', input_example[0])
    writer.add_image('output', x[0])
