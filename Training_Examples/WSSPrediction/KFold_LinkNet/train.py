...
if __name__ == "__main__":
    ...
    for fold_number, (train_loader, valid_loader, test_loader) in enumerate(split):
        ...
        # model goes here !!!!!!!!!!
        model = mt.Models.ResNetLinkNet(*config.model.args, **config.model.kwargs) 
        ...
        fit_callbacks = [
            ...
            mt.Callbacks.Validation(
                checkpoint=True, on_step=200, to_file=f'./fold_{fold_number}/valid/log',
